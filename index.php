        ...
        <div class="col-lg-12"><br>
            ...
            while($rw_producto_top=mysqli_fetch_array($sql_producto_top)){
                ...
                <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                    <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title="<?php echo $rw_producto_top['nombre'];?>" data-caption="<?php echo $rw_producto_top['descripcion'];	?>" data-image="view/administrador/producto/img/banner/<?php echo $rw_producto_top['url_image'];?>" data-target="#image-gallery">
                        <img class="img-responsive" src="view/administrador/producto/img/banner/<?php echo $rw_producto_top['url_image'];?>" alt="Another alt text">
                    </a>
                </div>
                <?php
