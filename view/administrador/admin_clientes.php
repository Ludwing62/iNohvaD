    ...
    <?php  
        ...
        {   
            echo  "<tr>";
                ...
                echo "<td><a title='ver pefil' href='../administrador/views/perfil.php?id={$row[0]}' class='btn btn-success'><span class='glyphicon glyphicon-user'></span></a> <a title='modificar perfil' href='modificar.php?id={$row[0]}' class='btn btn-info'><span class='glyphicon glyphicon-pencil'></span></a> <a title='Eliminar Perfil' href='php/delete.php?id={$row[0]}' class='btn btn-danger'><span class='glyphicon glyphicon-trash'></span></a></td>";
            echo  "</tr>";
        }
    ?>
