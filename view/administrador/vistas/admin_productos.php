        ...
        {   
            echo  "<tr>";
              ...
              // Botones de modificar y eliminar productos
                 echo "<td>
            <button type='button'  class='btn btn-info btn-lg' data-toggle='modal' data-target='#modifica_producto' title='Actualizar Producto'><span class='glyphicon glyphicon-pencil'></span></button>

            <button type='button'  class='btn btn-danger btn-lg' data-toggle='modal' data-target='#borrar_producto' title='Eliminar Producto'><span class='glyphicon glyphicon-trash'></span></button></td>";
            echo  "</tr>";

            // En este include, se llama al modal.
