...
#buscar{
  ...
  margin:10px; 
    ...
    <!-- NavBar principal para iniciar sesión -->
...
<center>
  ...
  <div class="datagrid"></div>
   ...
   <?php  
        ...
        $link = Conectarse();  
        $result= mysqli_query($link,"Select * from usuarios WHERE tipo_usuario = 1");
        ...
        {   
            echo  "<tr>";
              ...
              // Opciones de Eliminar y Modificar empleado, activa modal.
               echo "<td>
            <button type='button'  class='btn btn-info btn-lg' data-toggle='modal' data-target='#modifica_usuario' title='Modificar Usuario'><span class='glyphicon glyphicon-pencil'></span></button>

            <button type='button'  class='btn btn-danger btn-lg' data-toggle='modal' data-target='#borrar_usuario' title='Eliminar Usuario'><span class='glyphicon glyphicon-trash'></span></button></td>";
            echo  "</tr>";

            // Modal liminar usuario
            include '../modal/eliminar_usuario.php';
            // Moda Modificar usuario
